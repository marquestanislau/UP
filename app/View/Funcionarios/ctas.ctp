...
<div class="col-md-6">
    ...
    <?php echo $this->Form->input('Funcionario.id', array('type' => 'hidden', 'value' => $funcionario_id)); ?>
    <?php echo $this->Form->input('Cta.id', array('type' => 'hidden', 'value' => $funcionario['Cta']['id'])); ?>
    ...
    <?php echo $this->Form->input('Funcionario.delegacao_id', array('type' => 'hidden', 'value' => $concurso['delegacao_id'])); ?>
    <label for="FuncionarioNome">Nome</label>
    <?php echo $this->Form->input('Funcionario.nome', array('label'=>false, 'class' => 'w3-input w3-round w3-border w3-hover-khaki', 'value' => $funcionario['Funcionario']['nome'] ,'placeholder' => 'Estanislau', 'id' => 'nome'.$carreira_id)); ?>
    <label for="FuncionarioApelido">Apelido</label>
    <?php echo $this->Form->input('Funcionario.apelido', array('label'=>false, 'class' => 'w3-input w3-round w3-border w3-hover-khaki', 'value' => $funcionario['Funcionario']['apelido'] ,'placeholder' => 'Marques')); ?>
    <br>
     <div class="row">
       <div class="col-md-6">
         <?php echo $this->Form->label('Funcionario.sexo', 'Genero'); ?>
         <br>
         <?php echo $this->Form->radio('Funcionario.sexo', array('M' => 'Masculino', 'F' => 'Feminino'), array('value' => $funcionario['Funcionario']['sexo'], 'legend' => false, 'separator' => '<br>')); ?>
       </div>
       <div class="col-md-6">
         <?php echo $this->Form->input('Funcionario.posicao', array('class' => 'w3-input w3-round w3-border', 'label' => 'Posi&ccedil;&atilde;o', 'value' => $funcionario['Funcionario']['posicao'])); ?>
       </div>
     </div>
...
<div class="col-md-6">
  <div class="row">
    <div class="col-md-6">
      ...
      <?php echo $this->Form->input('Funcionario.contacto_pessoal', array('label'=>false, 'class' => 'w3-input w3-round w3-border w3-hover-khaki', 'value' => $funcionario['Funcionario']['contacto_pessoal'] ,'placeholder' => '841234567')); ?>
      <label for="FuncionarioContactoAlternativo">Contacto alternativo</label>
      <?php   echo $this->Form->input('Funcionario.contacto_alternativo', array('label'=>false, 'class' => 'w3-input w3-round w3-border w3-hover-khaki', 'value' => $funcionario['Funcionario']['contacto_alternativo'] ,'placeholder' => '821234567')); ?>
      <br>
      <?php echo $this->Form->label('Funcionario.data_nascimento', 'Data de Nascimento'); ?>
        <?php echo $this->Form->input('Funcionario.data_nascimento', array('label' => false, 'type' => 'text', 'class' => 'w3-input w3-text-blue w3-round w3-border datepicker', 'value' => $funcionario['Funcionario']['data_nascimento'] ,'placeholder' => '(Ano-Mes-Dia)', 'id' => 'datepicker'.$carreira_id , 'onfocus' => 'selecionador('.$carreira_id.')')); ?>
    </div>
    <div class="col-md-6">
    </div>
  </div>
...
<?php
  ...
  $this->Js->get('#ctasForm'.$carreira_id)->event(
    ...
    $this->Js->request(
        array(
            'controller' => 'ctas',
            'action' => 'edit/'.$funcionario['Cta']['id']
        ),
        array(
          'method' => 'post',
          'async' => true,
