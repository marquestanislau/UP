<div id="cabecalho">
	...
	<p class="corpo">
		Nome Completo <span class="bold"><?php echo $funcionario['Funcionario']['nome'].' '.$funcionario['Funcionario']['apelido']; ?>,</span> nomeado por despacho de <span class="bold"><?php echo $funcionario['Funcionario']['despacho']; ?></span> do Magnífico Reitor da Universidade Pedagógica, para <span class="bold"><?php echo $funcionario['Categoria']['nome'].', ';?></span><span class="bold">Carreira de <?php echo $funcionario['Carreira']['nome'].', '; ?></span><span class="bold"><?php echo $funcionario['Escalao']['nome']; ?></span>, nos termos do previsto no c&oacute;digo <?php echo $funcionario['Carreira']['codigo'].','; ?> da Resolução nº. <?php echo $funcionario['Carreira']['resolucao']; ?>, de 13 de Julho, conjugado com n.° <?php echo $funcionario['Carreira']['primeiro_numero']; ?> do art. <?php echo $funcionario['Carreira']['primeiro_artigo']; ?> e o n.° <?php echo $funcionario['Carreira']['segundo_numero']; ?> do art.° <?php echo $funcionario['Carreira']['segundo_artigo']; ?>, ambos do EGFAE, com colocação na <span class="bold"><?php echo $funcionario['Delegacao']['nome']; ?></span>.
		<br>
		<br>
