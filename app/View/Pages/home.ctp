...
<?php 
 ...
 <script type="text/javascript">
 	...
 	$(document).ready(function () {
 		$(document).on("change", "#concurso",function (event) {$.ajax({beforeSend:function (XMLHttpRequest) {$("#requesting").attr("style", "")}, complete:function (XMLHttpRequest, textStatus) {$("#requesting").attr("style", "display:none")}, data:$("#funcionarioSearch").serialize(), dataType:"html", success:function (data, textStatus) {$("#result").html(data);}, type:"post", url:"<?php str_replace('/', '\/', $uri); ?>funcionarios\/findAll"});
 			return false;});
 		$(document).on("change", "#carreira",function (event) {$.ajax({beforeSend:function (XMLHttpRequest) {$("#requesting").attr("style", "")}, complete:function (XMLHttpRequest, textStatus) {$("#requesting").attr("style", "display:none")}, data:$("#funcionarioSearch").serialize(), dataType:"html", success:function (data, textStatus) {$("#result").html(data);}, type:"post", url:"<?php str_replace('/', '\/', $uri); ?>funcionarios\/findAll"});
 			return false;});
 		$(document).on("change", "#delegacao",function (event) {$.ajax({beforeSend:function (XMLHttpRequest) {$("#requesting").attr("style", "")}, complete:function (XMLHttpRequest, textStatus) {$("#requesting").attr("style", "display:none")}, data:$("#funcionarioSearch").serialize(), dataType:"html", success:function (data, textStatus) {$("#result").html(data);}, type:"post", url:"<?php str_replace('/', '\/', $uri); ?>funcionarios\/findAll"});
 			return false;});
 		$(document).on("change", "#categoria",function (event) {$.ajax({beforeSend:function (XMLHttpRequest) {$("#requesting").attr("style", "")}, complete:function (XMLHttpRequest, textStatus) {$("#requesting").attr("style", "display:none")}, data:$("#funcionarioSearch").serialize(), dataType:"html", success:function (data, textStatus) {$("#result").html(data);}, type:"post", url:"<?php str_replace('/', '\/', $uri); ?>funcionarios\/findAll"});
 			return false;});
 		$(document).on("click", "#btnSubmit",function (event) {$.ajax({beforeSend:function (XMLHttpRequest) {$("#requesting").attr("style", "")}, complete:function (XMLHttpRequest, textStatus) {$("#requesting").attr("style", "display:none")}, data:$("#funcionarioSearch").serialize(), dataType:"html", success:function (data, textStatus) {$("#result").html(data);}, type:"post", url:"<?php str_replace('/', '\/', $uri); ?>funcionarios\/findAll"});
 			return false;});
