...
<div class="col-md-8 w3-padding w3-border w3-white">
    ...
    <table class="table table-striped">
        <tr>
            ...
            <td class="w3-text-dark-grey"><strong><?php echo h($usuario['User']['username']); ?></strong></td>
        </tr>
        <tr>
            <td class="w3-label"><?php echo __('Apelido'); ?></td>
            <td class="w3-text-dark-grey"><?php echo h($usuario['User']['apelido']); ?></td>
        </tr>
        <tr>
            <td class="w3-label"><?php echo __('Email'); ?></td>
            <td class="w3-text-dark-grey"><?php echo h($usuario['User']['email']); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="w3-text-dark-grey"><?php echo h($usuario['User']['contacto']); ?></td>
        </tr>
    </table>
