<div class="w3-white w3-text-blue">
	<h4><i class="fa fa-user"></i> <?php echo __('CTA / Novo Funcion&aacute;rio'); ?></h4>
</div>
<div class="w3-cell-row">
	<div class="w3-third w3-padding w3-topbar w3-border-green" style="background-color: #fafafa;">
	<h5><i class="fa fa-edit"></i> Dados pessoais</h5>
		...
		echo $this->Form->input('Funcionario.email_pessoal', array('class' => 'w3-input w3-hover-sand w3-border w3-round w3-white required','label' => array('class' => 'w3-margin-top')));
