...
<div id="header" class="w3-top">
  <ul class="w3-navbar w3-blue w3-theme w3-left-align w3-large">
    ...
    <li><a href="<?php echo $this->Html->url(array('controller' => 'pages', 'action' => '/'));?>" class="logo w3-theme-l1" style="font-weight: bolder;">SIGERH</a></li>
    <li>
      <a href="<?php echo $this->Html->url(array('action' => '/', 'controller' => 'pages'));?>"><span class="glyphicon glyphicon-home"></span> In&iacute;cio</a>
    </li>
